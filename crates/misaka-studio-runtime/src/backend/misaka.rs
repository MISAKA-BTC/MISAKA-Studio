...
//!
//! This is where the deterministic runtime the misakas repository already carries for PALW
...
/// The class tag that runtime will register under. Named here so the descriptor this
...
const REMEDY: &str = "Choose llama.cpp (or Auto) in Settings. This backend is reserved for the MISAKA PALW runtime and will refuse to run until it is connected — it will not silently use a different engine.";
