...
/// PALW work already has in the misakas node's repository — named now so the setting does not have
/// to be invented later, and refused at load time until it exists.
...
pub enum BackendKind {
    ...
    Mlx,
    /// The deterministic MISAKA runtime, from the node's repository. Not yet available here.
    Misaka,
